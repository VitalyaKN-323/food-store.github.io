            ...
            `
                <div class="card" data-product-id="${id}">
                    ...
                    <div class="card__bottom">
                        ...
                        <button class="card__order" data-product-id="${id}">Замовити</button> <!-- Додаємо кнопку "Замовити" -->
                    </div>
                </div>
            `;
...
// JavaScript for the order modal
...
// Function to handle "Замовити" button click
cards.addEventListener('click', (event) => {
    if (event.target.classList.contains('card__order')) {
        event.preventDefault();
        // Open the order modal
        orderModal.style.display = 'flex';

        // Optionally, you can set some data in the modal related to the product
